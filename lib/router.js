...
// bqsg
router.get('/bqsg/category/:category', require('./routes/bqsg/category'));
...
*/
// 5号站
router.get('/wuhaozhan', require('./routes/wuhaozhan/index'));
router.get('/wuhaozhan/index', require('./routes/wuhaozhan/index')); // 兼容

// 字幕库
router.get('/zimuku/subid/:subid', require('./routes/zimuku/subid'));
