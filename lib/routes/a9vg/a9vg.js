            ...
            list
                .map((index, item) => {
                    ...
                    return {
                        ...
                        description: item.find('.a9-rich-card-list_summary').text(), // + '<img referrerpolicy="no-referrer" src="' + item.find('img').attr('src') + '">',
                        pubDate: new Date(item.find('.a9-rich-card-list_infos .vdp-flex_none').text()).toUTCString(),
